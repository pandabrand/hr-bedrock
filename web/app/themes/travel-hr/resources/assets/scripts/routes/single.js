  ...
  init: function() {
    ...
    jQuery('#cc-map').ready(function() {
      ...
      for(x = 0; x < parsed_map_vars.locations.length; x++) {
        ...
        marker_place.bindPopup('<div class="cc-marker__popup"><div class="font-weight-bold">'+feature.title+'</div><div class="mt-2">'+feature.address +'</div><div class="mt-2"><a href="'+feature.directions+'" rel="external" target="_blank" class="text-capitalize"><i class="fa fa-map"></i> directions</a></div></div>');
